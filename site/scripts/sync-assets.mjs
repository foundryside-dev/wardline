// Copy the site-kit brand assets into wardline's public path.
//
...
// (README "Copy the assets"). Runs automatically via the pre{dev,build} hooks.
// Resolved from the installed package or the vendored copy.
