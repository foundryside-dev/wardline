...
def iter_calls_in_function_body(
    ...
    # Optimization: Eager list appending is significantly faster than recursive 'yield from'
    # in CPython due to reduced generator delegation overhead on deep AST paths.
