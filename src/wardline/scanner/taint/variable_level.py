    ...
    for node in nodes:
        ...
        if isinstance(node, ast.Assign):
            ...
            if (
                ...
                result = callee
        # ⚡ Bolt Optimization: Using ast.iter_child_nodes generator directly
        # instead of eager list() materialization prevents unnecessary memory
        # allocations during deep AST traversal.
...
def _collect_return_paths(
    ...
    for node in nodes:
        ...
        # ⚡ Bolt Optimization: Pass the generator directly to prevent eager
        # materialization, reducing memory overhead when analyzing large modules.
        _collect_return_paths(
