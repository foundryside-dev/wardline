...
_RULE_SHORT_DESCRIPTIONS: dict[RuleId, str] = {
    ...
    RuleId.GOVERNANCE_WEAK_ELIMINATION_PATH: "Exception elimination_path is a placeholder (governance)",
    RuleId.GOVERNANCE_RETROSPECTIVE_REQUIRED: "Retrospective scan recommended after control law improvement (governance)",
