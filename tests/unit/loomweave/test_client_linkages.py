"""T4.3 — LoomweaveClient call-graph linkage reads (GET /api/v1/entities/{id}/callers|callees).
...
def _client(transport):
    return LoomweaveClient("http://loomweave.example", secret="s3cr3t", project="proj", transport=transport)
