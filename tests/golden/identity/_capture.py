...
def _finding_sort_key(rec: dict[str, Any]) -> tuple[str, int, str, str]:
    loc = rec["location"]
    return (
        loc["path"] or "",
...
def _sarif_result_sort_key(res: dict[str, Any]) -> tuple[str, int, str, str]:
    ...
    return (uri or "", start, res["ruleId"], fp)
