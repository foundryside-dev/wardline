...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 60, "informational: int"),
    ("src/wardline/core/run.py", 68, "unanalyzed: int"),
    ...
    ("src/wardline/cli/scan.py", 362, "suppressed"),
    ("src/wardline/cli/scan.py", 370, "{s.active} active"),
    ("src/wardline/cli/scan.py", 388, "gate: FAILED"),
    # src/wardline/mcp/server.py — MCP scan summary + gate block
    ("src/wardline/mcp/server.py", 327, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 328, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 329, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 330, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 331, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 336, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 340, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 342, '"gate": {'),
    ("src/wardline/mcp/server.py", 343, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 346, '"verdict": decision.verdict'),
    # src/wardline/core/agent_summary.py — agent-summary JSON keys
    ("src/wardline/core/agent_summary.py", 116, '"total_findings"'),
    ("src/wardline/core/agent_summary.py", 117, '"active_defects"'),
    ("src/wardline/core/agent_summary.py", 118, '"suppressed_findings"'),
    ("src/wardline/core/agent_summary.py", 120, '"baselined"'),
    ("src/wardline/core/agent_summary.py", 121, '"waived"'),
    ("src/wardline/core/agent_summary.py", 122, '"judged"'),
    ("src/wardline/core/agent_summary.py", 123, '"informational"'),
    ("src/wardline/core/agent_summary.py", 124, '"unanalyzed"'),
    ("src/wardline/core/agent_summary.py", 127, '"tripped": self.gate.tripped'),
    ("src/wardline/core/agent_summary.py", 130, '"verdict": self.gate.verdict'),
    ...
    ("src/wardline/core/finding.py", 185, 'wardline["suppression_state"]'),
