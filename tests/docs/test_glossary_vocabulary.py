...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/mcp/server.py", 938, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 939, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 940, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 941, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 942, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 947, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 951, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 953, '"gate": {'),
    ("src/wardline/mcp/server.py", 954, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 958, '"verdict": decision.verdict'),
