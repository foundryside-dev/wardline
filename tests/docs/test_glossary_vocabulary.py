...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 100, "total: int"),
    ("src/wardline/core/run.py", 101, "active: int"),
    ("src/wardline/core/run.py", 103, "baselined: int"),
    ("src/wardline/core/run.py", 104, "waived: int"),
    ("src/wardline/core/run.py", 105, "judged: int"),
    ("src/wardline/core/run.py", 111, "informational: int"),
    ("src/wardline/core/run.py", 119, "unanalyzed: int"),
    ("src/wardline/core/run.py", 166, "gate_population: GatePopulation"),
    ("src/wardline/core/run.py", 198, "class GateDecision"),
    ("src/wardline/core/run.py", 208, "verdict: str"),
    ("src/wardline/core/run.py", 573, "Baseline(frozenset())"),
    ("src/wardline/core/run.py", 604, "def apply_delta_scope"),
    ("src/wardline/core/run.py", 649, "active=sum"),
