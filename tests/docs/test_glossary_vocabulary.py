...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 102, "total: int"),
    ("src/wardline/core/run.py", 103, "active: int"),
    ("src/wardline/core/run.py", 105, "baselined: int"),
    ("src/wardline/core/run.py", 106, "waived: int"),
    ("src/wardline/core/run.py", 107, "judged: int"),
    ("src/wardline/core/run.py", 113, "informational: int"),
    ("src/wardline/core/run.py", 121, "unanalyzed: int"),
    ("src/wardline/core/run.py", 168, "gate_population: GatePopulation"),
    ("src/wardline/core/run.py", 200, "class GateDecision"),
    ("src/wardline/core/run.py", 210, "verdict: str"),
    ("src/wardline/core/run.py", 593, "Baseline(frozenset())"),
    ("src/wardline/core/run.py", 624, "def apply_delta_scope"),
    ("src/wardline/core/run.py", 681, "active=sum"),
