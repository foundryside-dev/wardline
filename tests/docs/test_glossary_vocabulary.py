...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 70, "total: int"),
    ("src/wardline/core/run.py", 71, "active: int"),
    ("src/wardline/core/run.py", 73, "baselined: int"),
    ("src/wardline/core/run.py", 74, "waived: int"),
    ("src/wardline/core/run.py", 75, "judged: int"),
    ("src/wardline/core/run.py", 81, "informational: int"),
    ("src/wardline/core/run.py", 89, "unanalyzed: int"),
    ("src/wardline/core/run.py", 110, "gate_findings:"),
    ("src/wardline/core/run.py", 152, "class GateDecision"),
    ("src/wardline/core/run.py", 162, "verdict: str"),
    ("src/wardline/core/run.py", 486, "Baseline(frozenset())"),
    ...
    ("src/wardline/cli/scan.py", 564, "suppressed"),
    ("src/wardline/cli/scan.py", 565, "{s.active} active"),
    ("src/wardline/cli/scan.py", 617, "gate: FAILED"),
    # src/wardline/mcp/server.py — MCP scan summary + gate block
    ("src/wardline/mcp/server.py", 910, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 911, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 912, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 913, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 914, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 919, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 923, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 925, '"gate": {'),
    ("src/wardline/mcp/server.py", 926, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 930, '"verdict": decision.verdict'),
    # src/wardline/core/agent_summary.py — agent-summary JSON keys
    ("src/wardline/core/agent_summary.py", 128, '"total_findings"'),
    ("src/wardline/core/agent_summary.py", 129, '"active_defects"'),
    ("src/wardline/core/agent_summary.py", 130, '"suppressed_findings"'),
    ("src/wardline/core/agent_summary.py", 132, '"baselined"'),
    ("src/wardline/core/agent_summary.py", 133, '"waived"'),
    ("src/wardline/core/agent_summary.py", 134, '"judged"'),
    ("src/wardline/core/agent_summary.py", 140, '"informational"'),
    ("src/wardline/core/agent_summary.py", 141, '"unanalyzed"'),
    ("src/wardline/core/agent_summary.py", 144, '"tripped": self.gate.tripped'),
    ("src/wardline/core/agent_summary.py", 147, '"verdict": self.gate.verdict'),
    # informational display array (new, W3 residual fix)
    ("src/wardline/core/agent_summary.py", 165, '"informational": informational'),
