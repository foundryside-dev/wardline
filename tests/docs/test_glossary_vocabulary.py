...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/mcp/server.py", 951, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 952, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 953, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 954, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 955, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 960, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 964, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 967, '"gate": {'),
    ("src/wardline/mcp/server.py", 968, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 972, '"verdict": decision.verdict'),
    # src/wardline/core/agent_summary.py — agent-summary JSON keys
    ("src/wardline/core/agent_summary.py", 189, '"total_findings"'),
    ("src/wardline/core/agent_summary.py", 190, '"active_defects"'),
    ("src/wardline/core/agent_summary.py", 191, '"suppressed_findings"'),
    ("src/wardline/core/agent_summary.py", 193, '"baselined"'),
    ("src/wardline/core/agent_summary.py", 194, '"waived"'),
    ("src/wardline/core/agent_summary.py", 195, '"judged"'),
    ("src/wardline/core/agent_summary.py", 201, '"informational"'),
    ("src/wardline/core/agent_summary.py", 202, '"unanalyzed"'),
    ("src/wardline/core/agent_summary.py", 210, '"tripped": self.gate.tripped'),
    ("src/wardline/core/agent_summary.py", 213, '"verdict": self.gate.verdict'),
    # informational display array (new, W3 residual fix)
    ("src/wardline/core/agent_summary.py", 237, '"informational": informational'),
...
_MAPPING_TABLE_ANCHORS: tuple[tuple[str, str, int, str], ...] = (
    ...
    ("every finding", "src/wardline/mcp/server.py", 951, '"total": result.summary.total'),
    ("every finding", "src/wardline/core/agent_summary.py", 189, '"total_findings"'),
    ...
    ("live defect", "src/wardline/mcp/server.py", 952, '"active": result.summary.active'),
    ("live defect", "src/wardline/core/agent_summary.py", 190, '"active_defects"'),
    ...
    ("suppressed (sum)", "src/wardline/core/agent_summary.py", 191, '"suppressed_findings"'),
    ...
    ("baselined", "src/wardline/mcp/server.py", 953, '"baselined": result.summary.baselined'),
    ("baselined", "src/wardline/core/agent_summary.py", 193, '"baselined"'),
    ("waived", "src/wardline/core/run.py", 107, "waived: int"),
    ("waived", "src/wardline/mcp/server.py", 954, '"waived": result.summary.waived'),
    ("waived", "src/wardline/core/agent_summary.py", 194, '"waived"'),
    ("judged", "src/wardline/core/run.py", 108, "judged: int"),
    ("judged", "src/wardline/mcp/server.py", 955, '"judged": result.summary.judged'),
    ("judged", "src/wardline/core/agent_summary.py", 195, '"judged"'),
    ...
    ("informational (summary)", "src/wardline/core/agent_summary.py", 201, '"informational"'),
    ("informational (display)", "src/wardline/core/agent_summary.py", 237, '"informational": informational'),
    ("under-scan", "src/wardline/core/run.py", 122, "unanalyzed: int"),
    ("under-scan", "src/wardline/mcp/server.py", 964, '"unanalyzed": result.summary.unanalyzed'),
    ("under-scan", "src/wardline/core/agent_summary.py", 202, '"unanalyzed"'),
    ...
    ("gate verdict", "src/wardline/mcp/server.py", 967, '"gate": {'),
    ("gate verdict", "src/wardline/mcp/server.py", 968, '"tripped": decision.tripped'),
    ("gate verdict", "src/wardline/mcp/server.py", 972, '"verdict": decision.verdict'),
    ("gate verdict", "src/wardline/core/agent_summary.py", 210, '"tripped": self.gate.tripped'),
    ("gate verdict", "src/wardline/core/agent_summary.py", 213, '"verdict": self.gate.verdict'),
)
