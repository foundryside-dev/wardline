...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/mcp/server.py", 926, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 927, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 928, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 929, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 930, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 935, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 939, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 941, '"gate": {'),
    ("src/wardline/mcp/server.py", 942, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 946, '"verdict": decision.verdict'),
