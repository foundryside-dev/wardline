...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 69, "total: int"),
    ("src/wardline/core/run.py", 70, "active: int"),
    ("src/wardline/core/run.py", 72, "baselined: int"),
    ("src/wardline/core/run.py", 73, "waived: int"),
    ("src/wardline/core/run.py", 74, "judged: int"),
    ("src/wardline/core/run.py", 80, "informational: int"),
    ("src/wardline/core/run.py", 88, "unanalyzed: int"),
    ("src/wardline/core/run.py", 114, "gate_findings:"),
    ("src/wardline/core/run.py", 156, "class GateDecision"),
    ("src/wardline/core/run.py", 166, "verdict: str"),
    ("src/wardline/core/run.py", 493, "Baseline(frozenset())"),
    ("src/wardline/core/run.py", 503, "def apply_delta_scope"),
    ("src/wardline/core/run.py", 558, "active=sum"),
    ("src/wardline/core/run.py", 656, "honors_suppressions"),
    # src/wardline/cli/scan.py — CLI summary line + gate stderr
    ("src/wardline/cli/scan.py", 616, "suppressed"),
    ("src/wardline/cli/scan.py", 617, "{s.active} active"),
    ("src/wardline/cli/scan.py", 669, "gate: FAILED"),
