...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/mcp/server.py", 333, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 334, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 335, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 336, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 337, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 342, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 346, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 348, '"gate": {'),
    ("src/wardline/mcp/server.py", 349, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 352, '"verdict": decision.verdict'),
