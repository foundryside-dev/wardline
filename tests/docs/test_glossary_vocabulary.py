...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 166, "class GateDecision"),
    ("src/wardline/core/run.py", 176, "verdict: str"),
    ("src/wardline/core/run.py", 525, "Baseline(frozenset())"),
    ("src/wardline/core/run.py", 535, "def apply_delta_scope"),
    ("src/wardline/core/run.py", 596, "active=sum"),
