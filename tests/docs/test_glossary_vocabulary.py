...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/mcp/server.py", 336, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 337, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 338, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 339, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 340, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 345, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 349, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 351, '"gate": {'),
    ("src/wardline/mcp/server.py", 352, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 356, '"verdict": decision.verdict'),
