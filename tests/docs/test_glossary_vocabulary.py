...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 108, "gate_findings:"),
    ("src/wardline/core/run.py", 148, "class GateDecision"),
    ("src/wardline/core/run.py", 157, "verdict: str"),
    ("src/wardline/core/run.py", 456, "Baseline(frozenset())"),
    ("src/wardline/core/run.py", 484, "def apply_delta_scope"),
    ("src/wardline/core/run.py", 536, "active=sum"),
    ("src/wardline/core/run.py", 619, "honors_suppressions"),
    # src/wardline/cli/scan.py — CLI summary line + gate stderr
    ("src/wardline/cli/scan.py", 561, "suppressed"),
    ("src/wardline/cli/scan.py", 562, "{s.active} active"),
    ("src/wardline/cli/scan.py", 614, "gate: FAILED"),
    # src/wardline/mcp/server.py — MCP scan summary + gate block
    ("src/wardline/mcp/server.py", 1008, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 1009, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 1010, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 1011, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 1012, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 1017, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 1021, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 1023, '"gate": {'),
    ("src/wardline/mcp/server.py", 1024, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 1028, '"verdict": decision.verdict'),
