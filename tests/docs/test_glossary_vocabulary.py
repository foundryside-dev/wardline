...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 101, "total: int"),
    ("src/wardline/core/run.py", 102, "active: int"),
    ("src/wardline/core/run.py", 104, "baselined: int"),
    ("src/wardline/core/run.py", 105, "waived: int"),
    ("src/wardline/core/run.py", 106, "judged: int"),
    ("src/wardline/core/run.py", 112, "informational: int"),
    ("src/wardline/core/run.py", 120, "unanalyzed: int"),
    ("src/wardline/core/run.py", 167, "gate_population: GatePopulation"),
    ("src/wardline/core/run.py", 199, "class GateDecision"),
    ("src/wardline/core/run.py", 209, "verdict: str"),
    ("src/wardline/core/run.py", 585, "Baseline(frozenset())"),
    ("src/wardline/core/run.py", 616, "def apply_delta_scope"),
    ("src/wardline/core/run.py", 661, "active=sum"),
    ...
    ("src/wardline/cli/scan.py", 720, "gate: FAILED"),
    # src/wardline/mcp/server.py — MCP scan summary + gate block
    ("src/wardline/mcp/server.py", 944, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 945, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 946, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 947, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 948, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 953, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 957, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 959, '"gate": {'),
    ("src/wardline/mcp/server.py", 960, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 964, '"verdict": decision.verdict'),
