...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/mcp/server.py", 946, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 947, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 948, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 949, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 950, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 955, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 959, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 962, '"gate": {'),
    ("src/wardline/mcp/server.py", 963, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 967, '"verdict": decision.verdict'),
...
_MAPPING_TABLE_ANCHORS: tuple[tuple[str, str, int, str], ...] = (
    ...
    ("every finding", "src/wardline/mcp/server.py", 946, '"total": result.summary.total'),
    ...
    ("live defect", "src/wardline/mcp/server.py", 947, '"active": result.summary.active'),
    ...
    ("baselined", "src/wardline/mcp/server.py", 948, '"baselined": result.summary.baselined'),
    ("baselined", "src/wardline/core/agent_summary.py", 133, '"baselined"'),
    ("waived", "src/wardline/core/run.py", 107, "waived: int"),
    ("waived", "src/wardline/mcp/server.py", 949, '"waived": result.summary.waived'),
    ("waived", "src/wardline/core/agent_summary.py", 134, '"waived"'),
    ("judged", "src/wardline/core/run.py", 108, "judged: int"),
    ("judged", "src/wardline/mcp/server.py", 950, '"judged": result.summary.judged'),
    ...
    ("under-scan", "src/wardline/mcp/server.py", 959, '"unanalyzed": result.summary.unanalyzed'),
    ...
    ("gate verdict", "src/wardline/mcp/server.py", 962, '"gate": {'),
    ("gate verdict", "src/wardline/mcp/server.py", 963, '"tripped": decision.tripped'),
    ("gate verdict", "src/wardline/mcp/server.py", 967, '"verdict": decision.verdict'),
