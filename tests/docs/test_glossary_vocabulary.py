...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/mcp/server.py", 937, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 938, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 939, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 940, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 941, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 946, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 950, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 952, '"gate": {'),
    ("src/wardline/mcp/server.py", 953, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 957, '"verdict": decision.verdict'),
