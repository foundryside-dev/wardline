...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/cli/scan.py", 468, "suppressed"),
    ("src/wardline/cli/scan.py", 469, "{s.active} active"),
    ("src/wardline/cli/scan.py", 521, "gate: FAILED"),
    # src/wardline/mcp/server.py — MCP scan summary + gate block
    ("src/wardline/mcp/server.py", 905, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 906, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 907, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 908, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 909, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 914, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 918, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 920, '"gate": {'),
    ("src/wardline/mcp/server.py", 921, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 925, '"verdict": decision.verdict'),
