...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 83, "class GateDecision"),
    ("src/wardline/core/run.py", 247, "Baseline(frozenset())"),
    ("src/wardline/core/run.py", 257, "def apply_delta_scope"),
    ("src/wardline/core/run.py", 281, "active=sum"),
    ("src/wardline/core/run.py", 308, "honors_suppressions"),
    # src/wardline/cli/scan.py — CLI summary line + gate stderr
    ("src/wardline/cli/scan.py", 367, "suppressed"),
    ("src/wardline/cli/scan.py", 368, "{s.active} active"),
    ("src/wardline/cli/scan.py", 382, "gate: FAILED"),
    # src/wardline/mcp/server.py — MCP scan summary + gate block
    ("src/wardline/mcp/server.py", 314, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 315, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 316, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 317, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 318, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 322, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 334, '"gate": {'),
    ("src/wardline/mcp/server.py", 335, '"tripped": decision.tripped'),
