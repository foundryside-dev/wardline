...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 489, "Baseline(frozenset())"),
    ("src/wardline/core/run.py", 499, "def apply_delta_scope"),
    ("src/wardline/core/run.py", 554, "active=sum"),
    ("src/wardline/core/run.py", 648, "honors_suppressions"),
    # src/wardline/cli/scan.py — CLI summary line + gate stderr
    ("src/wardline/cli/scan.py", 568, "suppressed"),
    ("src/wardline/cli/scan.py", 569, "{s.active} active"),
    ("src/wardline/cli/scan.py", 621, "gate: FAILED"),
    # src/wardline/mcp/server.py — MCP scan summary + gate block
    ("src/wardline/mcp/server.py", 927, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 928, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 929, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 930, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 931, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 936, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 940, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 942, '"gate": {'),
    ("src/wardline/mcp/server.py", 943, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 947, '"verdict": decision.verdict'),
