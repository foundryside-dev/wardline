...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/mcp/server.py", 334, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 335, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 336, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 337, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 338, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 343, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 347, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 349, '"gate": {'),
    ("src/wardline/mcp/server.py", 350, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 353, '"verdict": decision.verdict'),
