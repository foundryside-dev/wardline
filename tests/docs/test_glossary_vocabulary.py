...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/core/run.py", 326, "Baseline(frozenset())"),
    ("src/wardline/core/run.py", 354, "def apply_delta_scope"),
    ("src/wardline/core/run.py", 378, "active=sum"),
    ...
    ("src/wardline/cli/scan.py", 468, "gate: FAILED"),
    # src/wardline/mcp/server.py — MCP scan summary + gate block
    ("src/wardline/mcp/server.py", 774, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 775, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 776, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 777, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 778, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 783, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 787, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 789, '"gate": {'),
    ("src/wardline/mcp/server.py", 790, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 794, '"verdict": decision.verdict'),
