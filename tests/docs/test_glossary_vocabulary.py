...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/cli/scan.py", 547, "suppressed"),
    ("src/wardline/cli/scan.py", 548, "{s.active} active"),
    ("src/wardline/cli/scan.py", 600, "gate: FAILED"),
    # src/wardline/mcp/server.py — MCP scan summary + gate block
    ("src/wardline/mcp/server.py", 998, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 999, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 1000, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 1001, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 1002, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 1007, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 1011, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 1013, '"gate": {'),
    ("src/wardline/mcp/server.py", 1014, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 1018, '"verdict": decision.verdict'),
