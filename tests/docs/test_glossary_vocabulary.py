...
_ANCHORS: tuple[tuple[str, int, str], ...] = (
    ...
    ("src/wardline/mcp/server.py", 329, '"total": result.summary.total'),
    ("src/wardline/mcp/server.py", 330, '"active": result.summary.active'),
    ("src/wardline/mcp/server.py", 331, '"baselined": result.summary.baselined'),
    ("src/wardline/mcp/server.py", 332, '"waived": result.summary.waived'),
    ("src/wardline/mcp/server.py", 333, '"judged": result.summary.judged'),
    ("src/wardline/mcp/server.py", 338, '"informational": result.summary.informational'),
    ("src/wardline/mcp/server.py", 342, '"unanalyzed": result.summary.unanalyzed'),
    ("src/wardline/mcp/server.py", 344, '"gate": {'),
    ("src/wardline/mcp/server.py", 345, '"tripped": decision.tripped'),
    ("src/wardline/mcp/server.py", 348, '"verdict": decision.verdict'),
