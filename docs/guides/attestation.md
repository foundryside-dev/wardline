...
```json
{
  ...
  "payload": {
    ...
    "sei_diagnostics": [
      {
        "qualname": "myapp.ingestion.parse_other",
        "reason": "Loomweave rejected resolve with 401 (auth)",
        "auth_status": 401
      }
    ]
  },
