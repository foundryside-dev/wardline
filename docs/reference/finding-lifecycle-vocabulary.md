...
| live defect | `N active` (`scan.py:404`) | `active` (`run.py:51,320`) | `active` (`server.py:331`) | `active_defects` (`agent_summary.py:135`) | no `suppression_state` key (`finding.py:285`) |
